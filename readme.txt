...
Tags: bbPress, new UI, UI, Forums, daniluk4000, Forum, Interface, Redesign, plugin, online, online status, design, lock, spam, spam lock
Tested up to: 4.8
Stable Tag: 3.5.0.2
...
= 3.5.0.2 =
* Fixed critical error in settings

= 3.5.0.1 =
* Fixed GlotPress translations

= 3.5 =
* Happy new year all! We are back, and there's new updated flat design of your forum - Feedback please!
* Meet Spam Block function - users can't write more than 1 reply in a row (only for user who haven't 'moderate' role)
* Some bugs have been fixed
* Screenshots have been updated
* Updated some icons

= 3.4.5.1 =
* Thank for use my plugin guys, I love you! 500+ active installations!
* Fixed bug with showing %s on some sites in reply permalink box
* Reduced revisions count for users to 1; Moderators can view all revisions (added in 3.4.5.1)
...
* New button in reply form: Spoiler, test it! Now in BETA version
* Improvements for images UI
* Improvements for revision UI
* Improvements for replies list UI
* Some improvements and fixes
* You can find the link to the Options page in your Plugin list page


= 3.3.3 =
* Inproducing: online status is now not in beta! Meet it :)
* Responsive design for topics and replies

= 3.3.2 =
* Bug fixes

= 3.3.1 =
* Color improvements for date, #xxxx permalink and admin links
* Now the "Hide the copyright" functions are working for forums too

= 3.3 =
* In 3.3.0.1: One layout fix that I forgotten
...
* Added Poedit support for all strings (except "This reply/topic of a moderator/admin, it's translating automatically in all languages)
* Next will be replies redesign and refunctional!
...
= 3.0.1 =
* Many fixes for yesterday broken dark theme release
